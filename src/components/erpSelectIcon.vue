<template>
  <div class="erp-select">
    ...
    <div class="card options" v-if="areOptionsVisible">
      ...
      <p v-for="(option,i) in filteredList" :key="i" class="" style="font-size: 14.5px; padding: 6px 15px;" :class="{'activeDownSelect': i==downIndex}"
          @click="selectOption(option)"
      >
        <mdb-icon fab :icon="option.icon_base_64_str" :style="{'color': option.note}" class="mr-2"/> {{option.name}}
      </p>
