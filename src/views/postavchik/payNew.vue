    ...
    <div v-else class="pay_page">
      ...
      <div class="mx-3 mb-1">
        <div style="position:relative;">
          <input type="text" v-model="client_address"
        ...
        <div style="position:relative;" class="mt-3" v-show="client_note != null">
          <input type="text" v-model="client_note"
      ...
      <div class="d-flex justify-content-end mx-3 mt-0">
        <mdb-btn color="primary" @click="closeUpdateOrder" style="font-size: 9px"
            p="r4 l4 t2 b2">
          {{$t('update')}}</mdb-btn>
        <mdb-btn color="success" @click="promise" style="font-size: 9px"
            p="r4 l4 t2 b2">
          {{$t('pay')}}</mdb-btn>
      </div>
      ...
      <mdb-modal :show="confirm" @close="confirm = false" size="sm" class="text-center" danger>
        ...
        <mdb-modal-body>
          <span><span class="text-primary font-weight-bold">{{client_name}} </span> ga zakazni olib borilganini tasdiqlamoqchimisz ?</span>
        </mdb-modal-body>
        <mdb-modal-footer center>
          <mdb-btn outline="danger" @click="payed">{{$t('Yes')}}</mdb-btn>
...
<script>
import {mdbBtn,mdbModal, mdbModalHeader, mdbModalBody, mdbModalFooter,mdbBadge,mdbBtnGroup, mdbDropdown, mdbDropdownMenu, mdbDropdownItem,} from "mdbvue"
...
export default {
  components:{
    ...
    LoaderTable,
    mdbModal,
    mdbModalHeader, mdbModalBody, mdbModalFooter, mdbBadge, mdbBtnGroup, mdbDropdown, mdbDropdownMenu, mdbDropdownItem,
},
  data() {
    return {
      modal_info: '',
  ...
  methods: {
    async fetchMounted(id){
      try{
        ...
        this.note = data.note;
        this.client_address = data.address.address;
        this.client_note = data.note;
